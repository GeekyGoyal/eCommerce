              ...
              <div class='button-card mt-4'>
                <div class='action-buttons mb-3 mt-2'>
                  <a
                    href='#loginModal2'
                    data-toggle='modal'
                    class='btn btn-theme btn-primary text-white'
                  >
                    Login
                  </a>
                  <a
                    href='#registerModal2'
                    data-toggle='modal'
                    class='btn btn-theme btn-success text-white'
                  >
                    Register
                  </a>
                </div>
                {/* <img src={require('../assets/style-2-demo-dark.jpg')} /> */}
              </div>
            </div>
          </div>
        </div>
              ...
              <div class='modal-body'>
                <form class='mt-3'>
                  ...
                  <div class='social-login text-center'>
                    <a
                      class=' btn-facebook  text-uppercase'
          ...
          <div class='modal-dialog modal-login'>
            <div class='modal-content'>
              ...
              <div class='modal-footer'>
                ...
                <a href='#loginModal2' data-dismiss='modal' data-toggle='modal'>
                  {' '}
                  Login
                </a>
              </div>
